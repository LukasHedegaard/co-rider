...
test:
	@echo ⚡⚡⚡ Testing ⚡⚡⚡
	py.test --cov corider --cov-report term-missing
...
lint:
	...
	flake8 . --max-complexity=12 --max-line-length=90 --select=C,E,F,W,B,B950,BLK --ignore=E203,E231,E501,W503,BLK100 --exclude=.cache
